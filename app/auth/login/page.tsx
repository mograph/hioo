  ...
  return (
    <div className="min-h-[calc(100vh-56px)] flex items-center justify-center px-5">
      <div className="w-full max-w-sm">
        <div className="mb-8">
          <h1 className="font-display text-3xl font-bold text-[#0A0A0A] tracking-tight">Welcome back</h1>
          <p className="text-[#525252] mt-1">Sign in to your wardrobe</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <form onSubmit={handleEmail} className="space-y-3">
            <input
              ...
              placeholder="Email"
              className="w-full px-4 py-3 rounded-xl border-2 border-[#E5E5E5] text-sm font-medium focus:outline-none focus:border-[#0A0A0A] transition-colors bg-white"
            />
            <input
        ...
        <p className="text-center text-sm text-[#525252] mt-8">
          ...
          <Link href="/auth/register" className="text-[#FF6B35] hover:underline font-semibold">Sign up</Link>
        </p>
      </div>
    </div>
  )
